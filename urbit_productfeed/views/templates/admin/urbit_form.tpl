        ...
        <script>
            (function ($) {
                ...
                $(document).on("click", ".attribute-add", function () {
                    ...
                    $new.find(".additional-attributes-item__name").attr("name", "URBIT_PRODUCTFEED_ATTRIBUTE_ADDITIONAL_ATTRIBUTE_NEW[" + i + "][name]");
                    $new.find(".additional-attributes-item__type").attr("name", "URBIT_PRODUCTFEED_ATTRIBUTE_ADDITIONAL_ATTRIBUTE_NEW[" + i + "][type]");
                    $new.find(".additional-attributes-item__unit").attr("name", "URBIT_PRODUCTFEED_ATTRIBUTE_ADDITIONAL_ATTRIBUTE_NEW[" + i + "][unit]");
