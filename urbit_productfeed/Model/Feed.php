...
class Urbit_Productfeed_Feed
{
    ...
    public function toArray()
    {
        ...
        $feedArray = [
            '$schema'            => Configuration::get('URBIT_PRODUCTFEED_SCHEMA', null) ?: "https://raw.githubusercontent.com/urbitassociates/urbit-merchant-feeds/master/schemas/products/{$version}/products.json",
            'content_language'   => Configuration::get('URBIT_PRODUCTFEED_CONTENT_LANGUAGE', null) ?: $lang,
            'attribute_language' => Configuration::get('URBIT_PRODUCTFEED_CONTENT_LANGUAGE', null) ?: $lang,
            'content_type'       => Configuration::get('URBIT_PRODUCTFEED_CONTENT_TYPE', null) ?: 'products',
            'target_country'     => Configuration::get('URBIT_PRODUCTFEED_TARGET_COUNTRY', null)
                ? explode(",", Configuration::get('URBIT_PRODUCTFEED_TARGET_COUNTRY', null)) : [$lang],
            'version'            => Configuration::get('URBIT_PRODUCTFEED_VERSION', null) ?: $version,
            'feed_format'        => [
                "encoding" => Configuration::get('URBIT_PRODUCTFEED_FEED_FORMAT', null) ?: "UTF-8",
            ],
            'schedule'           => [
        ...
        if ($created_at = Configuration::get('URBIT_PRODUCTFEED_CREATED_AT', null)) {
            $feedArray['created_at'] = $created_at;
        }

        if ($updated_at = Configuration::get('URBIT_PRODUCTFEED_UPDATED_AT', null)) {
